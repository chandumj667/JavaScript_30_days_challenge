/**
 * 2694. Event Emitter
 * LeetCode problem link: https://leetcode.com/problems/event-emitter/?utm_campaign=PostD27&utm_medium=Post&utm_source=Post&gio_link_id=lPQDyGjR
 * 
...
class EventEmitter {
    ...
    subscribe(event, cb) {
        ...
        const callbackList = this.subscriptions.get(event);
        callbackList.push(cb);

        const index = callbackList.length - 1;
